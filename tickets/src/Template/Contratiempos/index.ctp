                     ...
                     <div class="col-md-9">
                      ...
                      <?= $this->Html->link('<i class="fa fa-arrow-left"  aria-hidden="true"></i> Ir a menu', ['controller' => 'Dashboards', 'action' => 'menu'] ,  array("class"=>"btn btn-primary btn-lg pull-right  ",'escape' => false)  ) ?>     
                                ...
                                <div class="w3l-table-info agile_info_shadow">
                                      ...
                                      <div class="col-md-3">
                                         <?= $this->Html->link('<i class="fa fa-pencil"  aria-hidden="true"></i> Agregar', ['controller' => 'Contratiempos', 'action' => 'add'] ,  array("class"=>"btn btn-success btn-lg  pull-right  ",'escape' => false)  ) ?>
                                         </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <?= $this->Html->link(__('Editar'), ['action' => 'edit', $contratiempo->id]) ?>
                    <?= $this->Form->postLink(__('Eliminar'), ['action' => 'delete', $contratiempo->id], ['confirm' => __('Are you sure you want to delete # {0}?', $contratiempo->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
