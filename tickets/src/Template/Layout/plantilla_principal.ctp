...
<link href="/tickets/css/export.css" rel="stylesheet" type="text/css" media="all" />
<link href="/tickets/css/flipclock.css" rel="stylesheet" type="text/css" media="all" />
<link href="/tickets/css/circles.css" rel="stylesheet" type="text/css" media="all" />
...
<div class="wthree_agile_admin_info">
		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
				...
				<!-- //nav_agile_w3l -->
				<li class="second logo"><h1><a href="main-page.html"><i class="fa fa-graduation-cap" aria-hidden="true"></i>SOPORTE</a></h1></li>
					<li class="second admin-pic">
				       <ul class="top_dp_agile">
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<span class="prfil-img"><img style="min-height: 100px; max-height: 100px " src="images/admin.jpg" alt=""> </span> 
											</div>	
										</a>
				...
				<li class="second w3l_search">
						...
						<div class="notification_bottom">
													<a  href="/tickets/users/logout"><i class="fa fa-sign-out"></i></a>
												</div> 
...
<script type="text/javascript" src="/tickets/js/jquery-2.1.4.min.js"></script>
	...
	<!-- /amcharts -->
				<script src="/tickets/js/amcharts.js"></script>
		       <script src="/tickets/js/serial.js"></script>
				<script src="/tickets/js/export.js"></script>	
				<script src="/tickets/js/light.js"></script>
				<!-- Chart code -->
	 <script>
...
var chart = AmCharts.makeChart("chartdiv1", {
	...
	<!-- //amcharts -->
		<script src="/tickets/js/chart1.js"></script>
				<script src="js/Chart.min.js"></script>
		<script src="js/modernizr.custom.js"></script>
		
		<script src="/tickets/js/classie.js"></script>
		<script src="/tickets/js/gnmenu.js"></script>
		<script>
...
<!-- /circle-->
	 <script type="text/javascript" src="/tickets/js/circles.js"></script>
					         <script>
								var colors = [
	...
	<!-- //circle -->
	<!--skycons-icons-->
<script src="/tickets/js/skycons.js"></script>
<script>
...
<script src="/tickets/js/screenfull.js"></script>
		...
		<script src="/tickets/js/flipclock.js"></script>
...
<script src="/tickets/js/bars.js"></script>
